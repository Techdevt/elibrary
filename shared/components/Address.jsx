			...
			component = <div className="Settings__main--big">
				<div>
					<div className="inner-div">
						...
						<AutosizeInput type="text" name="fullName" defaultValue={this.state.fullName} onChange={onFieldChange} readOnly={!editable} />
					</div>
				</div>
				<div>
					<div className="inner-div">
						<h2 className="dash_title">Address Line 1</h2>
						<AutosizeInput type="text" name="addressLine1" defaultValue={this.state.addressLine1} onChange={onFieldChange} readOnly={!editable} />
					</div>
				</div>
				<div>
					<div className="inner-div">
						<h2 className="dash_title">Address Line 2</h2>
						<AutosizeInput type="text" name="addressLine2" defaultValue={this.state.addressLine2} onChange={onFieldChange} readOnly={!editable} />
					</div>
				</div>
				<div>
					<div className="inner-div">
						<h2 className="dash_title">Postcode</h2>
						<AutosizeInput type="text" name="postCode" defaultValue={this.state.postCode} onChange={onFieldChange} readOnly={!editable} />
					</div>
					<div className="inner-div">
						<h2 className="dash_title">State</h2>
						<AutosizeInput type="text" name="state" defaultValue={this.state.state} onChange={onFieldChange} readOnly={!editable} />
					</div>
				</div>
				<div>
					<div className="inner-div">
						<h2 className="dash_title">Country</h2>
						<AutosizeInput type="text" name="country" defaultValue={this.state.country} onChange={onFieldChange} readOnly={!editable} />
					</div>
					<div className="inner-div">
						<h2 className="dash_title">Zip</h2>
						<AutosizeInput type="text" name="zip" defaultValue={this.state.zip} onChange={onFieldChange} readOnly={!editable} />
					</div>
				</div>
				<div>
					<div className="inner-div">
						<h2 className="dash_title">Phone</h2>
						<AutosizeInput type="text" name="phone" defaultValue={this.state.phone} onChange={onFieldChange} readOnly={!editable} />
					</div>
					<div className="inner-div">
						<h2 className="dash_title">City</h2>
						<AutosizeInput type="text" name="city" defaultValue={this.state.city} onChange={onFieldChange} readOnly={!editable} />
					</div>
				</div>
			</div>;
		} else {
