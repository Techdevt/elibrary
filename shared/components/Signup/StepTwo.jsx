...
class StepTwo extends Component {
	...
	matchPassword = (event) => {
		((event.target.value.length > 0) && (event.target.value !== this.state.password) ) ? this.setState({passMatchError: 'Passwords do not match', passwordPassed: false}) : this.setState({passMatchError: '', passwordPassed: true});
	};
